        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpecificLocation = table.Column<string>(maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoundAndLostItem", x => new { x.FoundItemId, x.LostItemId });
                    table.ForeignKey(
                        name: "FK_FoundAndLostItem_FoundItems_FoundItemId",
                        column: x => x.FoundItemId,
                        principalTable: "FoundItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FoundAndLostItem_LostItems_LostItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoundAndLostItem_LostItemId",
                table: "FoundAndLostItem",
                column: "LostItemId");
